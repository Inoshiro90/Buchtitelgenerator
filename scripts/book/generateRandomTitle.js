...
//     const genrePromises = selectedGenres.map(genre => getGenreTitle(noun, adjective, name, location, genre));
//     const genreArrays = await Promise.all(genrePromises);

//     const genreArraysMapping = {};
//     selectedGenres.forEach((genre, index) => {
//         genreArraysMapping[genre] = genreArrays[index];
//     });

//     const bookTitleIdeas = [];

//     for (const genre of selectedGenres) {
//         const genreArray = genreArraysMapping[genre];
//         if (genreArray) {
//             const randomTitle = getRandomElement(genreArray);
//             if (randomTitle) {
//                 bookTitleIdeas.push(randomTitle);
